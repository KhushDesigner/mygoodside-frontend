...
import { ArrowLeft, UserPlus, Plus, LayoutGrid, User, Calendar } from 'lucide-react';
import './Profile.scss';
                ...
                <div className="profilePage__inner">
                    ...
                    <div className="profileHeader">
                        <div className="profileHeader__info">
                            <img src={userAvatar} alt="User Profile" className="profileAvatar" />
                            <div className="profileDetails">
                                <h1 className="profileName">YOUR MEMORIES</h1>
                                <p className="profileStats">2 events • 8 photos</p>
                            </div>
                        </div>
                        <div className="profileHeader__actions">
                            <button className="button button--outline addFriendBtn">
                                <UserPlus size={18} /> Add friend
                            </button>
                            <button
                                className="button createPhotoBtn"
